...
\begin{enumerate}
  ...
  The properties builder utilizes a textual CTL syntax to specify custom properties using the atomic propositions from the previous section, see \autoref{fig:implScreenshotCTLProperties}.
  ...
  \begin{figure}[ht]
      \centering
      \frame{\includegraphics[width=.8\textwidth]{images/impl_step3_ctl_properties.png}}
      \caption{CTL properties tab in the \textit{analysis step} of the BPMN Analyzer}
      \label{fig:implScreenshotCTLProperties}
  \end{figure}
...
\begin{figure}[ht]
    ...
    \caption{Screenshot of the Token Editor used in the BPMN Analyzer}
