...
As mentioned in section \autoref{sec:introduction}, modelers may use our approach to specify custom properties consisting of atomic propositions and logical operators from CTL.
...
\begin{enumerate}
  ...
  \item The \textbf{Custom Propositions} section contains our custom \textit{Token Editor} and is shown in \autoref{fig:impl_step2}.
...
\end{figure}
  ...
  \item In the \textbf{Analysis} section, users may check the general BPMN properties and build custom CTL properties using the atomic propositions. 
  The properties builder utilizes a textual CTL syntax to specify custom properties using the atomic propositions from the previous section, see \autoref{fig:impl_step3_ctl}.
