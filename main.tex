...
% TODO: Describe Rule 2

% Could be split up into MITE and MICE.
\begin{figure}[ht]
    \centering
...
% General description
TBD
\autoref{fig:terminateEventTemplate} depicts the rule generation template for \textit{signal events} (\textsf{SE} in \autoref{fig:bpmnelementsOverview}).
% SSE, SITE, SBE, SEE
