...
This makes sense since the \gls*{hot} algorithm has linear runtime complexity since it is essentially iterating over all flow nodes of a \gls*{bpmn} model to generate \gls*{gt} rules.
