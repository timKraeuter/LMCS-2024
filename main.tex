...
To calculate the average runtime, we used the hyperfine benchmarking tool \cite{peterHyperfine2022} (version 1.18.0), which ran state space exploration for each \gls*{bpmn} model ten times.
