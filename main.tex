...
Each \textsf{Token} points to the \textsf{element} it is currently positioned at, which is either an \textsf{Activity} or \textsf{SequenceFlow}, see BPMN metamodel in \autoref{fig:bpmnMetamodel}.
