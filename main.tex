...
Using our formalization approach, BPMN models may be verified against behavioural properties ---both general and user-defined--- by utilizing the generated GT system (see \autoref{fig:approach}).
...
As mentioned in section bla, modellers may use our appraoch to specify user-defined properties consisting of atomic propositions and logical operators from CTL.
