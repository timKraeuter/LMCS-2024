...
Plenty of optimization potential, such as parallelization, on-the-fly model checking, avoiding costly I/O operations, \etc, still exists.
which can lead to future improvements in runtime. 
