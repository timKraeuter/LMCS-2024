...
This proposition can be used to define a property to check if shipping always occurs.
...
\begin{enumerate}
  ...
  In \autoref{fig:impl_step2}, the user is editing the first of three created propositions.
...
\begin{figure}[ht]
    \centering
    % long with step buttons.
    \frame{\includegraphics[width=1\textwidth]{images/impl_step2_long.png}}
...
\end{figure}
  ...
  The three atomic propositions created in the previous step (see \autoref{fig:impl_step2}) are available to the user.
