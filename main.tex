...
\section{Scalability experiment} \label{sec:scalability}

In this section, we describe a scalability experiment of our approach when applied to 300 \gls*{bpmn} models with increasing model size. 
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.5\textwidth]{images/StateSpaceGeneration_scalability.pdf}
    \caption{Three different blocks of BPMN elements}
    \label{fig:blocks}
\end{figure}
...
\autoref{table:inputModels} states characteristics of the generated BPMN models, such as the number of gateways, flow nodes, and sequence flows. 
All models, including information about their characteristics and how to generate them, can be found in \cite{krauterArtifactsLMCS2023}.
