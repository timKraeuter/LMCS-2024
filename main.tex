...
\begin{enumerate}
  ...
  \item The \textbf{Custom Propositions} section contains the proposition editor.
...
%Second, 
The CTL properties builder in the analysis section comes with CTL templates to facilitate commonly occurring CTL properties.
