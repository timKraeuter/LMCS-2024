...
Using the rule builder, one can construct a GT rule by defining which nodes and edges should be present (lines 4-6), deleted (lines 7-9), added (lines 10-12), or NACs (lines 13-15), see \autoref{lst:grooveRuleBuilder}.
