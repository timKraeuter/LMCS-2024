...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.6\textwidth]{images/shippingAfterPayment.pdf}
...
% TODO: Same idea about the tradeoff. Maybe some "CTL"/temporal logic templates for ease of use. Never reached and can reach.
