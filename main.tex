...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.8\textwidth]{images/twice.pdf}
    \caption{Abstract syntax \textbf{(a)} and graph condition in Groove \textbf{(b)} to define the snapshot and tokens for the atomic proposition in \autoref{fig:shippedTwiceProposition}.}
...
Model checking is a useful technique but can fall short when transferred to the industry due to insufficient performance \cite{clarkeHandbookModelChecking2018}.
