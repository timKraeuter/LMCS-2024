...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.65\textwidth]{images/twice.png}
    \caption{Atomic proposition defining shipping goods twice in abstract syntax (a) and Groove syntax (b)}
...
BPMN Analyzer generates a GT system for the supplied BPMN model and run model checking against the specified properties in Groove \cite{kastenbergModelCheckingDynamic2006}. 
